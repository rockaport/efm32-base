...
{
  emAfPluginMicriumRtosAcquireCommandMutex();
  emAfPluginMicriumRtosSendBlockingCommand(EMBER_MAC_GET_PARENT_ADDRESS_IPC_COMMAND_ID,
                                           "vbu",
  ...
  emAfPluginMicriumRtosFetchApiParams("uvbu",
                                      &status,
                                      &parentAddress->addr.shortAddress,
                                      parentAddress->addr.longAddress,
                                      &longAddressSize,
...
static void macGetParentAddressCommandHandler(void)
{
  ...
  emAfPluginMicriumRtosSendResponse(EMBER_MAC_GET_PARENT_ADDRESS_IPC_COMMAND_ID,
                                    "uvbu",
                                    status,
                                    parentAddress.addr.shortAddress,
                                    parentAddress.addr.longAddress,
...
{
  emAfPluginMicriumRtosAcquireCommandMutex();
  emAfPluginMicriumRtosSendBlockingCommand(EMBER_SET_SELECTIVE_JOIN_PAYLOAD_IPC_COMMAND_ID,
                                           "b",
                                           payload,
                                           payloadLength);
...
static void setSelectiveJoinPayloadCommandHandler(void)
{
  ...
  EmberStatus status = emApiSetSelectiveJoinPayload(payloadLength,
                                                    payload);
  emAfPluginMicriumRtosSendResponse(EMBER_SET_SELECTIVE_JOIN_PAYLOAD_IPC_COMMAND_ID,
                                    "u",
                                    status);
}
...
{
  emAfPluginMicriumRtosAcquireCommandMutex();
  emAfPluginMicriumRtosSendBlockingCommand(EMBER_CLEAR_SELECTIVE_JOIN_PAYLOAD_IPC_COMMAND_ID,
                                           "");
...
static void clearSelectiveJoinPayloadCommandHandler(void)
{
  ...
  emAfPluginMicriumRtosSendResponse(EMBER_CLEAR_SELECTIVE_JOIN_PAYLOAD_IPC_COMMAND_ID,
                                    "u",
                                    status);
}
