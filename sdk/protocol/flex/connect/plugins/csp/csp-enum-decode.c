...
// Messaging
    ...
    case EMBER_MAC_ADD_SHORT_TO_LONG_ADDRESS_MAPPING_COMMAND_IDENTIFIER:
      return "EMBER_MAC_ADD_SHORT_TO_LONG_ADDRESS_MAPPING_COMMAND_IDENTIFIER";
    case EMBER_MAC_ADD_SHORT_TO_LONG_ADDRESS_MAPPING_RETURN_IDENTIFIER:
      return "EMBER_MAC_ADD_SHORT_TO_LONG_ADDRESS_MAPPING_RETURN_IDENTIFIER";
    case EMBER_MAC_CLEAR_SHORT_TO_LONG_ADDRESS_MAPPINGS_COMMAND_IDENTIFIER:
      return "EMBER_MAC_CLEAR_SHORT_TO_LONG_ADDRESS_MAPPINGS_COMMAND_IDENTIFIER";
    case EMBER_MAC_CLEAR_SHORT_TO_LONG_ADDRESS_MAPPINGS_RETURN_IDENTIFIER:
      return "EMBER_MAC_CLEAR_SHORT_TO_LONG_ADDRESS_MAPPINGS_RETURN_IDENTIFIER";
...
// Network Management
    ...
    case EMBER_SET_SELECTIVE_JOIN_PAYLOAD_COMMAND_IDENTIFIER:
      return "EMBER_SET_SELECTIVE_JOIN_PAYLOAD_COMMAND_IDENTIFIER";
    case EMBER_SET_SELECTIVE_JOIN_PAYLOAD_RETURN_IDENTIFIER:
      return "EMBER_SET_SELECTIVE_JOIN_PAYLOAD_RETURN_IDENTIFIER";
    case EMBER_CLEAR_SELECTIVE_JOIN_PAYLOAD_COMMAND_IDENTIFIER:
      return "EMBER_CLEAR_SELECTIVE_JOIN_PAYLOAD_COMMAND_IDENTIFIER";
    case EMBER_CLEAR_SELECTIVE_JOIN_PAYLOAD_RETURN_IDENTIFIER:
      return "EMBER_CLEAR_SELECTIVE_JOIN_PAYLOAD_RETURN_IDENTIFIER";
