...
{
  emSendBinaryManagementBlockingCommand(EMBER_MAC_GET_PARENT_ADDRESS_COMMAND_IDENTIFIER,
                                        "vbu",
...
static void emberMacGetParentAddressReturn(void)
{
  EmberStatus status;
  status = emberUnsignedCommandArgument(0);

  uint16_t shortAddress;
  shortAddress = emberUnsignedCommandArgument(1);

  uint8_t* longAddress;
  uint8_t longAddressSize;
  longAddress = (uint8_t*)emberStringCommandArgument(2, &(longAddressSize));

  uint8_t mode;
  mode = emberUnsignedCommandArgument(3);
...
EmberStatus emberMacAddShortToLongAddressMapping(EmberNodeId shortId,
                                                 EmberEUI64 longId)
{
  emSendBinaryManagementBlockingCommand(EMBER_MAC_ADD_SHORT_TO_LONG_ADDRESS_MAPPING_COMMAND_IDENTIFIER,
                                        "vb",
                                        shortId,
                                        longId, EUI64_SIZE);
...
static void emberMacAddShortToLongAddressMappingReturn(void)
{
  EmberStatus status;
  status = emberUnsignedCommandArgument(0);
...
{
  emSendBinaryManagementBlockingCommand(EMBER_MAC_CLEAR_SHORT_TO_LONG_ADDRESS_MAPPINGS_COMMAND_IDENTIFIER,
                                        "");
...
static void emberMacClearShortToLongAddressMappingsReturn(void)
{
  EmberStatus status;
  status = emberUnsignedCommandArgument(0);
...
static void messageSentHandlerCallback(void)
{
  ...
  message.ackRssi = emberUnsignedCommandArgument(7);
  emAfCallbacksFetchOrAppend(FALSE /* APPEND */,
                             "vuuvuuubu",
                             &identifier,
                             &status,
...
static void macMessageSentHandlerCallback(void)
{
  ...
  message.length = emberUnsignedCommandArgument(14);
  message.payload = (uint8_t *)emberStringCommandArgument(15, &(message.length));
  message.ackRssi = emberUnsignedCommandArgument(16);
  emAfCallbacksFetchOrAppend(FALSE /* APPEND */,
                             "vuuvbuvbuvvuuuwubu",
                             &identifier,
                             &status,
...
EmberStatus emberSetSelectiveJoinPayload(uint8_t payloadLength,
                                         uint8_t *payload)
{
  emSendBinaryManagementBlockingCommand(EMBER_SET_SELECTIVE_JOIN_PAYLOAD_COMMAND_IDENTIFIER,
                                        "b",
                                        payload,
                                        payloadLength);
...
static void emberSetSelectiveJoinPayloadReturn(void)
{
  EmberStatus status;
  status = emberUnsignedCommandArgument(0);
...
{
  emSendBinaryManagementBlockingCommand(EMBER_CLEAR_SELECTIVE_JOIN_PAYLOAD_COMMAND_IDENTIFIER,
                                        "");
...
static void emberClearSelectiveJoinPayloadReturn(void)
{
  EmberStatus status;
  status = emberUnsignedCommandArgument(0);
...
{
  emSendBinaryManagementBlockingCommand(EMBER_MAC_FORM_NETWORK_COMMAND_IDENTIFIER,
                                        "vuu",
                                        parameters->panId,
                                        parameters->radioTxPower,
                                        parameters->radioChannel);
...
static void emberMacFormNetworkReturn(void)
{
  EmberStatus status;
  status = emberUnsignedCommandArgument(0);
...
const EmberCommandEntry managementCallbackCommandTable[] =
{
  ...
  emberBinaryCommandEntryAction(EMBER_GET_EUI64_RETURN_IDENTIFIER,
                                ...
                                "b",
                                NULL),
  emberBinaryCommandEntryAction(EMBER_MAC_GET_PARENT_ADDRESS_RETURN_IDENTIFIER,
                                emberMacGetParentAddressReturn,
                                "uvbu",
                                NULL),
  ...
  emberBinaryCommandEntryAction(EMBER_PURGE_INDIRECT_MESSAGES_RETURN_IDENTIFIER,
                                ...
                                "u",
                                NULL),
  emberBinaryCommandEntryAction(EMBER_MAC_ADD_SHORT_TO_LONG_ADDRESS_MAPPING_RETURN_IDENTIFIER,
                                emberMacAddShortToLongAddressMappingReturn,
                                "u",
                                NULL),
  emberBinaryCommandEntryAction(EMBER_MAC_CLEAR_SHORT_TO_LONG_ADDRESS_MAPPINGS_RETURN_IDENTIFIER,
                                emberMacClearShortToLongAddressMappingsReturn,
                                "u",
                                NULL),
  ...
  emberBinaryCommandEntryAction(EMBER_SET_APPLICATION_BEACON_PAYLOAD_RETURN_IDENTIFIER,
                                ...
                                "u",
                                NULL),
  emberBinaryCommandEntryAction(EMBER_SET_SELECTIVE_JOIN_PAYLOAD_RETURN_IDENTIFIER,
                                emberSetSelectiveJoinPayloadReturn,
                                "u",
                                NULL),
  emberBinaryCommandEntryAction(EMBER_CLEAR_SELECTIVE_JOIN_PAYLOAD_RETURN_IDENTIFIER,
                                emberClearSelectiveJoinPayloadReturn,
                                "u",
                                NULL),
  ...
  emberBinaryCommandEntryAction(EMBER_JOIN_NETWORK_RETURN_IDENTIFIER,
                                ...
                                "u",
                                NULL),
  emberBinaryCommandEntryAction(EMBER_MAC_FORM_NETWORK_RETURN_IDENTIFIER,
                                emberMacFormNetworkReturn,
                                "u",
                                NULL),
