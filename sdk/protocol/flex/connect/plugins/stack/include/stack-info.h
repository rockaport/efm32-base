 ...
 *
 * @param[in] power  Desired radio output power, in dBm.
 *
 ...
 *
 * @param[in] radioOn  If this parameter is true, the radio is turned on,
 ...
 *
 * @param[in] checkCca   If set to TRUE, the node  performs a clear
 ...
 *                               the active stack tasks at the time of the API
 *						         call.
 *
