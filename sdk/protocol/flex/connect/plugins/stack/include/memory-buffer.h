...
/** @brief Prevents the garbage collector from reclaiming the memory
...
/** @brief Returns a pointer to the memory segment corresponding to
...
/** @brief Returns the length in bytes of the passed ::EmberBuffer
 * buffer.
 *
 * @param[in] buffer   A pointer to the ::EmberBuffer buffer for which the
